...
func GetDailyStats(db *sql.DB, userID int, startDate, endDate time.Time) ([]models.DailyStats, error) {
...
func GetTasksCompletedOnDate(db *sql.DB, userID int, date time.Time) ([]models.Task, error) {
	query := `
