// Package fact provides fact-related data access and business logic
// for the Zettelgarden tool registry.
//
// This package contains functions for managing facts and fact searches.
package fact
...
// ExecuteFactTextSearch performs text-based fact search using Typesense
...
// executeFactTextSearchFallback performs text-based fact search using SQL when Typesense fails
...
// ExecuteFactSemanticSearch performs semantic fact search using Typesense embeddings
