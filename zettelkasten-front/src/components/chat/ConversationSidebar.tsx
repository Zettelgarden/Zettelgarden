      ...
      <div className="pt-4 px-4 pb-2">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 bg-white border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          />
          {searchQuery && (
            <button
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg className={`w-3 h-3 ${showStarredOnly ? 'text-yellow-600' : 'text-gray-500'}`} fill={showStarredOnly ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
