...
export const FileRender = ({ file }: FileRenderProps) => {
  ...
  const isImage = file.filetype === "image/png" || file.filetype === "image/jpeg" || file.filetype === "image/jpg" || file.filetype === "image/gif" || file.filetype === "image/webp";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-[1000]">
      <div className="bg-white rounded-lg shadow-lg w-[90%] max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-auto p-4">
          ...
          {!isLoading && isImage && (
            <img src={fileSrc} alt={file.name} className="max-w-full h-auto mx-auto" />
          )}
