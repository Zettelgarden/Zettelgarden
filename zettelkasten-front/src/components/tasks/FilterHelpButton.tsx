...
export function FilterHelpButton({ showHelp, onToggle }: FilterHelpButtonProps) {
  return (
    <button
      type="button"
      onClick={onToggle}
...
export function FilterHelpPopover({ visible, onClose }: FilterHelpPopoverProps) {
      ...
      <div className="absolute top-full mt-2 left-0 bg-white p-4 border border-slate-200 rounded-lg shadow-xl z-30 w-80">
        ...
        <ul className="space-y-2 text-sm text-slate-600">
          <li className="flex items-start gap-2">
            <span className="text-slate-400 font-mono text-xs mt-0.5">text</span>
            <span>Search by title (e.g., <code className="bg-slate-100 px-1 rounded text-xs">meeting</code>)</span>
          </li>
          <li className="flex items-start gap-2">
          ...
          <li className="flex items-start gap-2">
            <span className="text-purple-500 font-mono text-xs mt-0.5">priority:X</span>
            <span>A, B, C, or D</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-600 font-mono text-xs mt-0.5">status:X</span>
            <span>todo, in_progress, blocked, done</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-orange-500 font-mono text-xs mt-0.5">date:X</span>
            <span>today, tomorrow, or YYYY-MM-DD</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-slate-500 font-mono text-xs mt-0.5">show:completed</span>
            <span>Include completed tasks</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-pink-500 font-mono text-xs mt-0.5">has:reminder</span>
