...
export function SavedSearchesMenu({
  ...
  return (
    <Menu
      ...
      triggerClassName="h-9 inline-flex items-center gap-1 px-2.5 border border-slate-300 rounded-md text-sm bg-white hover:bg-slate-50 text-slate-600 transition-colors"
      panelClassName="w-72 z-30"
      button={
        <>
          <svg
