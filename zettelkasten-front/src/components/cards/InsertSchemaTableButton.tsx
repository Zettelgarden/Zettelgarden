...
export function InsertSchemaTableButton({
  onInsert,
}: InsertSchemaTableButtonProps) {
  ...
  const changeFilterField = (index: number, fieldName: string) => {
    setFilters((prev) =>
      prev.map((f, i) =>
        i === index
          ? { field: fieldName, operator: 'eq' as FilterOperator, value: '' }
          : f,
      ),
    );
  };
    ...
    <Popover className="relative inline-block">
      ...
      >
        ...
        >
          <path
            fillRule="evenodd"
            d="M5 4a1 1 0 00-2 0v7a1 1 0 001 1h7a1 1 0 001-1V4a1 1 0 00-1-1H5zM3 14a1 1 0 011-1h7a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2zm12-5a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"
            clipRule="evenodd"
          />
        </svg>
        Schema Table
                    ...
                    return (
                      ...
                      >
                        <select
                          value={filter.field}
                          onChange={(e) =>
                            changeFilterField(index, e.target.value)
                          }
