...
export const CardBodyTextArea = forwardRef<
...
>(
  (
    ...
    } = useCardReference({ editingCard, textareaRef, setEditingCard });
    const { handleListKeyDown } = useListEditing({
      editingCard,
      textareaRef,
      setEditingCard,
    });
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLTextAreaElement>) => {
      ...
      // Handle wiki-link card reference popup (triggers on [[)
