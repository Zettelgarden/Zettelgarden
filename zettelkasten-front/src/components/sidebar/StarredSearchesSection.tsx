              ...
              <li key={search.id} className="px-2 py-0.5 text-sm group">
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity min-w-[44px] min-h-[44px] flex items-center justify-center px-1"
