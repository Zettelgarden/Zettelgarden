...
export function EntityListToolbar({
  ...
  return (
    <div className="mb-4 flex gap-2">
      ...
      <button
        onClick={onSearch}
        className="px-4 py-3 min-h-[44px] bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        Search
      </button>
      <select
