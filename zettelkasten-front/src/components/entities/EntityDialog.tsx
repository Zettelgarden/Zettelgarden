...
export function EntityDialog({ onClose, onEdit }: EntityDialogProps) {
  ...
  async function handleConfirmMerge() {
    ...
    const primaryEntityId =
      mergeDirection === 'into-current' ? selectedEntity.id : entityToMerge.id;
    const secondaryEntityId =
      mergeDirection === 'into-current' ? entityToMerge.id : selectedEntity.id;
