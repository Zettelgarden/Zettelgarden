...
const APIKeysManagement: React.FC<APIKeysManagementProps> = () => {
  ...
  const [justCreatedKey, setJustCreatedKey] = useState<{ id: number; key: string; name: string } | null>(null);
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Create API keys for programmatic access to Zettelgarden. These keys provide long-lived access beyond JWT token expiration limits.
        </p>
      </div>
      ...
      {justCreatedKey && (
        <div className="mb-6 bg-green-50 border border-green-200 rounded-md p-4">
          ...
          <p className="text-green-700 text-sm mb-3">
            <strong>{justCreatedKey.name}</strong> - Copy this key now. It will only be shown once and cannot be retrieved later.
          </p>
      ...
      {showCreateForm && (
        <div className="mb-6 bg-gray-50 border border-gray-200 rounded-md p-4">
          ...
          <form onSubmit={handleCreateKey}>
            ...
            <div className="mb-4">
              <label htmlFor="keyDescription" className="block text-sm font-medium text-gray-700 mb-1">
      ...
      <div className="space-y-4">
        {apiKeys && apiKeys.length === 0 ? (
          ...
          apiKeys && apiKeys.map((key) => (
            <div key={key.id} className="border border-gray-200 rounded-md p-4 bg-white">
        ...
        <div className="flex">
          ...
          <div>
            ...
            <p className="mt-1 text-yellow-700 text-sm">
              API keys provide persistent access to your account. Store them securely and treat them like passwords.
              Revoked keys cannot be recovered. If you suspect a key has been compromised, revoke it immediately.
            </p>
          </div>
        </div>
      </div>
