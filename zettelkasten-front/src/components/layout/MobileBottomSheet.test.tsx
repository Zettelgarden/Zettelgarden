...
describe("MobileBottomSheet", () => {
  ...
  it("should not render close button when showCloseButton is false", () => {
    render(
      <MobileBottomSheet isOpen={true} onClose={vi.fn()} showCloseButton={false}>
        <div>Content</div>
      </MobileBottomSheet>
    );
  ...
  it("should call onClose when close button is clicked", () => {
    ...
    render(
      <MobileBottomSheet isOpen={true} onClose={handleClose} showCloseButton={true}>
        <div>Content</div>
      </MobileBottomSheet>
    );
  ...
  it("should have drag handle for visual affordance", () => {
    ...
    const dragHandle = container.querySelector(".w-12.h-1\\.5.bg-gray-300.rounded-full");
