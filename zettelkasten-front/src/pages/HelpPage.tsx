...
export function HelpPage() {
  const [activeCategory, setActiveCategory] =
    useState<HelpCategory['id']>('quickstart');
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Learn how to make the most of your personal knowledge management
          system.
        </p>
      ...
      <footer className="mt-16 p-6 bg-gray-50 rounded-lg">
        ...
        <p className="text-gray-600">
          Can't find what you're looking for? Try exploring the interface
          directly - many elements have helpful tooltips when you hover over
          them.
        </p>
      </footer>
    </div>
