      ...
      {billingEnabled === false ? (
        <div className="text-center py-20">
          ...
          <p className="text-gray-600 max-w-md mx-auto">
            This instance has billing disabled, so all features are available to
            everyone. There are no plans to purchase.
          </p>
        </div>
      ) : (
        <>
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Upgrade to Zettelgarden Pro to unlock intelligent AI agents that can
            work with your knowledge base, advanced summarization, fact
            extraction, and early access to new features.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch flex-wrap">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-sm flex flex-col">
              ...
              <ul className="text-left mb-6 space-y-2">
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> Create and
                  Organize Cards
                </li>
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> Knowledge
                  Linking and Organization
                </li>
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> Manage your
                  Todos With Your Cards
                </li>
              </ul>
              <button
            ...
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-sm flex flex-col">
              ...
              <ul className="text-left mb-6 space-y-2">
                ...
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> AI Agents with
                  Tool-Using Capabilities
                </li>
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> AI Entity and
                  Fact Extraction
                </li>
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> Card
                  Summarization and Analysis
                </li>
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span> Early Access To
                  New Features
                </li>
              </ul>
              <button
            ...
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-sm flex flex-col">
              ...
              <p className="text-gray-700 mb-1">
                $100 / year <span className="text-green-600">(Save 20%)</span>
              </p>
              <p className="text-sm text-green-600 mb-3">
                30-day free trial included
              </p>
